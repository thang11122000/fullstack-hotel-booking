...
const AllRooms = () => {
  ...
  const handleFilterChange = (
    checked: boolean,
    value: string,
    type: keyof SelectedFiltersProps
  ) => {
  ...
  const matchesPriceRange = useCallback(
    (room) => {
      return (
        ...
        selectedFilters.priceRange.some((range: string) => {
  ...
  const sortRoom = (a, b) => {
    switch (selectedSort) {
      case "Price Low to High":
        return a.pricePerNight - b.pricePerNight; // Sort by price in ascending order
      case "Price High to Low":
        return b.pricePerNight - a.pricePerNight; // Sort by price in descending order
      case "Newest First":
        return (
